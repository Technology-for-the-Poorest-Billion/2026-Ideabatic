...
Although the temperature difference was reduced, substantial variation remained throughout the test, suggesting that the air gap within the bottle is unlikely to be the sole cause of the non-uniform cooling. The results are consistent with the hypothesis that segmentation of the air gap may influence the cooling behaviour of the system. However, the observed improvement was relatively small and the ambient temperature fluctuated throughout the experiment, affecting the temperatures measured within the carousel. Therefore, it cannot be concluded with certainty that the reduction in temperature difference was solely attributable to the inserts, and further testing under more controlled conditions would be required to confirm their effect.
